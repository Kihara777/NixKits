// Generated FFI bindings for riscv64gc-unknown-linux-gnu.
//
// Copy of rquickjs-sys 0.12.2 pre-generated x86_64-unknown-linux-gnu.rs.
// Upstream ships byte-identical files for every LP64 little-endian target
// (x86_64 == aarch64 == loongarch64 == powerpc64), but 0.12.2 does not ship
// riscv64 bindings at all, which breaks cross builds (see build.rs
// non-bindgen path). Added by NixKits for codewhale riscv64.
// Source: rquickjs-sys 0.12.2 (MIT), https://crates.io/crates/rquickjs-sys
