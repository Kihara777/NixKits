---
name: nixkits-skills
description: 将 NixKits 技能安装或更新到编码助手目录（opencode、codewhale、codex、openclaw、agents）。支持本地和在线两种安装模式。DeepSeek Harness (dsh) 不再作为安装目标——其 NixOS 场景能力由 nixos-shell 插件提供。
---
