...
| 包 | `nix develop` | 文档 |
|------|---------------|------|
| opencode | `nix develop nixkits#opencode` | [devshell](docs/zh/devshell.md) |
| ruyi | `nix develop nixkits#ruyi`<br>`nix develop nixkits#ruyi-beta`<br>`nix develop nixkits#ruyi-alpha` | [ruyi](docs/zh/ruyi.md) |
