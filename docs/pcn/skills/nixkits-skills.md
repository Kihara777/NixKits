...
**Claude Code** 2026-07 支援終了：

> Claude Code 企業 KYC 及選択利用者地域権利保有理解、利用者資料基国籍推論業務論理組込行為、如何目的理由、安全模型境界深刻越、最基礎利用者信頼破壊。
>
> 以上理由、本倉庫当該軟体利用者対必要性再評価可能作業流移行強推奨。本倉庫利用者需要多様性個人選択十分尊重、当危険告知義務有。本倉庫内容使用起因 Anthropic 口座異常損失発生場合、当該事象本倉庫無関係承認。
