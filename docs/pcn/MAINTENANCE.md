...
中文 | [English](docs/MAINTENANCE.en.md) | [日本語](../MAINTENANCE.ja.md) | [ｶﾀﾘｯｼｭ](docs/MAINTENANCE.katalish.md) | 偽中国語
...
| `7caf343` | refactor(translate-katakana): rename kata-en → katalish, use as canonical name |
