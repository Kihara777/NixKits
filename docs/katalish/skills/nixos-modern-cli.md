...
> Activated on NixOS systems. Ensures modern Nix CLI usage, full shell capability, ｱﾝﾄﾞ correct maintenance procedures.
...
- Covers system maintenance, log viewing, ｱﾝﾄﾞ garbage collection
...
Auto-activated when ｻﾞ AI detects a NixOS environment, or on explicit request for "modern nix commands".