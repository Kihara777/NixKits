...
[中文] | ｶﾀﾘｯｼｭ(docs/MAINTENANCE.en.md) | [日本語](MAINTENANCE.ja.md) | [ｶﾀﾘｯｼｭ](docs/MAINTENANCE.katalish.md) | [偽中国語](docs/MAINTENANCE.pcn.md)
...
| `7ba8c1d` | fix(katalish): 语言切换器中 ｶﾀﾘｯｼｭ 不应本地化为片假名 |
...
| Commit | Description |
|------|------|
| `358316c` | docs: add ｶﾀﾘｯｼｭ and Japanese translations with I18n structure |
| `bef3b4b` | docs: add ｶﾀﾘｯｼｭ and Japanese README with language switcher |
