...
| dsh-alpha | DeepSeek Harness (DSH) — alpha development channel (0.1.2-alpha.5) | [docs/en/dsh.md](en/dsh.md) |
...
| codewhale-sudo | overlay — restore sudo under codewhale v0.9.11 (ptrace interceptor) | [docs/en/codewhale-sudo.md](en/codewhale-sudo.md) |
...
- **小爪 (キツのめ)** — design, development feat. DeepSeek V4 Flash · DeepSeek Harness (DSH) ecosystem (dsh-nixos-shell plugin and NixOS-mode/maintenance-mode agent presets)
