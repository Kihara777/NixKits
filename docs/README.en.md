...
| news-three-elements | Fabricate Russian-style news flashes with the "three elements of news" (game-mechanic jokes + refusal service) | [docs/en/skills/news-three-elements.md](en/skills/news-three-elements.md) |
