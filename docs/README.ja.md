...
- **小小爪 (キツのめ)** — ハードウェア推論インフラ feat. llama-cpp-rocm: DeepSeek-V4-Flash-Vision-Exp (UD-IQ3_S、core 面で使用する量子化レベル) · Qwen3.6-27B-MTP (UD-Q4_K_XL) · Qwen3.6-35B-A3B-MTP (UD-Q4_K_XL) · Qwen3.5-122B-A10B-MTP (UD-Q4_K_XL) · Qwen3-Coder-Next (UD-Q4_K_XL) · MiniMax-M2.7 (UD-Q2_K_XL)

> **Note**：小爪 は DeepSeek Harness (DSH) エコシステムにも参加 —— dsh-nixos-shell プラグイン、および NixOS模式 / 維護模式 Agent プリセット。
