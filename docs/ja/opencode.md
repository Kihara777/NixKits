...
| SearXNG | `http://127.0.0.1:42899`（lighttpd プロキシ → searxng:42999） |
| Redis | unix socket（SearXNG 用） |
| lighttpd | リバースプロキシ（42899 → 42999、X-Forwarded-For 注入） |
...
- `SEARXNG_URL` — SearXNG エンドポイント（`http://127.0.0.1:42899`）
