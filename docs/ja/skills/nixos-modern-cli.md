...
[中文](../../zh/skills/nixos-modern-cli.md) | [English](../../en/skills/nixos-modern-cli.md) | 日本語  | [偽中国語](../../pcn/skills/nixos-modern-cli.md)
...
- 機密の整理：git 管理下の flake リポジトリ内に機密を置けない理由と、リポジトリ外ディレクトリ + `path:` input による導入方法、およびその二つの罠（`flake.lock` による固定、`...` が引数を束縛しないこと）
