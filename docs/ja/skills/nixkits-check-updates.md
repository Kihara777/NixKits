...
[中文](../../zh/skills/nixkits-check-updates.md) | [English](../../en/skills/nixkits-check-updates.md) | 日本語 | [Katalish](../../katalish/skills/nixkits-check-updates.md) | [Pseudo-Chinese](../../pcn/skills/nixkits-check-updates.md)
...
- 全言語のドキュメントのバージョン番号を同期
- 更新後に `write-maintenance-log` スキルを自動呼出し、メンテナンス記録を作成
