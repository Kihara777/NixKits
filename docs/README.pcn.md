...
| ruyi<br>ruyi-beta<br>ruyi-alpha | RuyiSDK 包管理器（RISC-V 開發工具）<br>stable 0.52.0 · beta 0.53.0-beta.20260917 · alpha 0.54.0-alpha.20260918 | [docs/pcn/ruyi.md](pcn/ruyi.md) |
...
曾 保守、現在 廃止 工程（多数 上流 同等 能力 内蔵 故）。索引：[`DEPRECATED.md`](../DEPRECATED.md)：

| 工程 | 説明 | 詳細 |
|------|------|------|
| comfyui-rocm | ComfyUI 之 ROCm 補丁工程 —— 上流 内蔵 済、補丁 全部 削除 | [pcn/deprecated/comfyui-rocm.md](pcn/deprecated/comfyui-rocm.md) |
...
安全政策（**評価済 外部報告一覧** 含——解決済 誤検出 再受理 不）[`SECURITY.md`](../SECURITY.md) 参照。
