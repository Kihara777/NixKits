...
| Version | `0.1.5-rc.1` |
| Development channel | `dsh-alpha 0.1.5-alpha.2` (npm `alpha` dist-tag) |
| License | MIT |
| Command | `dsh` |
...
| `pkgs.dsh-alpha` | alpha | `0.1.5-alpha.2` | npm `alpha` dist-tag, tracks the latest development build |
