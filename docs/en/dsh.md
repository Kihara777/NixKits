...
- **Voice broadcast**: a dedicated panel row provides a 「Speak usage」 dropdown — speak current usage / balance, or audition the low-usage and out-of-tokens warning audio; a voice-alert toggle announces automatically when the balance drops below the threshold.
