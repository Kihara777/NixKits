...
| Path | `skills/news-three-elements/SKILL.md` |
| Trigger | 「新闻三要素」 |
...
Activated by the AI assistant when the user sends 「新闻三要素」 or 「新闻三要素，启动！」:

- "新闻三要素" → improvise on the spot, with no fiction disclaimer
- "新闻三要素，启动！" → resume fabricating
