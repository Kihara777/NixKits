...
| ソフトウェア | 追加バージョン |
|-------------|--------------|
| comfyui-strix-halo | パッチ（ROCm 7.2 wheels 内蔵） |
...
| 　 | tui hash | 追加 `sha256-tc/s3e1oomJhfYEN1EtuEtPBF77dByrMimDH3bQibCI=` |
...
| ソフトウェア | 追加バージョン |
|-------------|--------------|
| llama-cpp-rocm | 動的（ビルド時に上流最新 Release を取得） |
...
| ソフトウェア | 追加バージョン |
|-------------|--------------|
| kitsfmt | 自前（`packages/kitsfmt-src/`） |
...
| ソフトウェア | 追加バージョン |
|-------------|--------------|
| rcc-fix | nixpkgs 追従（overlay + patch） |
