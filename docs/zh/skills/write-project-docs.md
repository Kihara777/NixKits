...
[中文](write-project-docs.md) | [English](../../en/skills/write-project-docs.md) | [日本語](../../ja/skills/write-project-docs.md) | [偽中国語](../../pcn/skills/write-project-docs.md)
...
- kata-en 语言支持 — 调用 translate-katakana 技能生成片假名英语翻译
- 编写分类 README（含语言切换器）
- 编写模块文档（基本信息表 + 安装 + 引用）
